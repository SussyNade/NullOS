...
static const char *const g_msgs[] = {
    ...
    [MSG_CRASH_SAVED] = "  Crash information saved.\n",
    [MSG_CRASH_NOT_SAVED] = "  Crash information could NOT be saved (no usable config sector or no disk).\n",
    [MSG_CRASH_RESTARTING] = "  Restarting into Safe Mode...\n",
    [MSG_SAFE_MENU_6] = "  6. View last crash details\n",
    [MSG_SAFE_REASON_CRASH_1] = "Reason: the system crashed: ",
    [MSG_SAFE_REASON_CRASH_2] = " at EIP ",
    [MSG_SAFE_REASON_CRASH_HINT] = "Press 6 for the details of the crash.\n",
    [MSG_SAFE_CRASH_TITLE] = "Last crash details\n\n",
    [MSG_SAFE_CRASH_NONE] = "No crash is recorded.\n",
    [MSG_SAFE_CRASH_EXC] = "Exception     : ",
    [MSG_SAFE_CRASH_VECTOR] = " (vector ",
    [MSG_SAFE_CRASH_VECTOR_END] = ")\n",
    [MSG_SAFE_CRASH_EIP] = "EIP           : ",
    [MSG_SAFE_CRASH_ERR] = "Error code    : ",
    [MSG_SAFE_CRASH_CR2] = "CR2 (address) : ",
    [MSG_SAFE_CRASH_PF] = "Page fault    : ",
    [MSG_SAFE_CRASH_FETCH] = ", instruction fetch",
    [MSG_SAFE_CRASH_RSVD] = ", reserved bit set",
    [MSG_SAFE_CRASH_UPTIME] = "Uptime        : ",
    [MSG_SAFE_CRASH_TICKS] = " ticks (",
    [MSG_SAFE_CRASH_SECONDS] = " s)\n",
    [MSG_SAFE_CRASH_STATE] = "Status        : ",
    [MSG_SAFE_CRASH_PENDING] = "not acknowledged yet (choose \"Reboot normally\" to acknowledge it)\n",
